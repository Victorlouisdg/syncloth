...
def add_white_stripes_on_black_nodes(
...
def create_striped_dish_towel_material(
    ...
    stripes = add_white_stripes_on_black_nodes(
...
def create_gridded_dish_towel_material(
    ...
    vertical_stripes = add_white_stripes_on_black_nodes(
        node_tree, separate_xyz.outputs["X"], amount_of_vertical_stripes, vertical_stripe_width
    )
    horizontal_stripes = add_white_stripes_on_black_nodes(
