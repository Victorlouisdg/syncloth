...
for i in range(num_frames):
    ...
    t = i * frame_interval
    tcp_pose = fold_trajectory(t)
    gripper_base.matrix_world = Matrix(tcp_pose @ tcp_inverse_transform)
    bpy.context.view_layer.update()
    gripper_base.keyframe_insert(data_path="location")
    gripper_base.keyframe_insert(data_path="rotation_euler")
